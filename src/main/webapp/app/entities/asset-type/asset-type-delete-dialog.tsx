...
export const AssetTypeDeleteDialog = (props: IAssetTypeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="prospectServiceApp.assetType.delete.question">
        <Translate contentKey="prospectServiceApp.assetType.delete.question" interpolate={{ id: assetTypeEntity.id }}>
