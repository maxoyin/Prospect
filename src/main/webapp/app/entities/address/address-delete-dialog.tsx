...
export const AddressDeleteDialog = (props: IAddressDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="prospectServiceApp.address.delete.question">
        <Translate contentKey="prospectServiceApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
