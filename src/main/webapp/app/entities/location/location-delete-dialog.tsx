...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="prospectServiceApp.location.delete.question">
        <Translate contentKey="prospectServiceApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
