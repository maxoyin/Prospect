...
export class AddressDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('prospectServiceApp.address.delete.question'));
...
export default class AddressComponentsPage {
  ...
  async deleteAddress() {
    ...
    expect(await addressDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/prospectServiceApp.address.delete.question/);
