...
export class AgentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('prospectServiceApp.agent.delete.question'));
...
export default class AgentComponentsPage {
  ...
  async deleteAgent() {
    ...
    expect(await agentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/prospectServiceApp.agent.delete.question/);
