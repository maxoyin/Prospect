...
export class LocationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('prospectServiceApp.location.delete.question'));
...
export default class LocationComponentsPage {
  ...
  async deleteLocation() {
    ...
    expect(await locationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/prospectServiceApp.location.delete.question/);
