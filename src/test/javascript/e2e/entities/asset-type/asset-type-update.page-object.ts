...
export default class AssetTypeUpdatePage {
  pageTitle: ElementFinder = element(by.id('prospectServiceApp.assetType.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  nameInput: ElementFinder = element(by.css('input#asset-type-name'));
  descriptionInput: ElementFinder = element(by.css('input#asset-type-description'));
  createdAtInput: ElementFinder = element(by.css('input#asset-type-createdAt'));
  updatedAtInput: ElementFinder = element(by.css('input#asset-type-updatedAt'));
